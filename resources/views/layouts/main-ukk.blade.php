                ...
                <ul class="nav nav-list">
                    ...
                    <li class="ripple">
                      <a href="/ukk-view#/ukk-peps">
                         <span class="fa fa-file-pdf-o"></span>Dokumen PEPs
                      </a>
                    </li>
                    <li class="ripple">
                      <a href="/ukk-view#/ukk-dttot">
                         <span class="fa fa-file-pdf-o"></span>Dokumen DTTOT
                      </a>
                    </li>
                  </ul>
                </div>
        ...
        <div class="mimin-mobile-menu-list">
            <div class="col-md-12 sub-mimin-mobile-menu-list animated fadeInLeft">
                <ul class="nav nav-list">
                    ...
                    <li class="ripple">
                      <a href="/ukk-view#/ukk-peps">
                         <span class="fa fa-user"></span>Dokumen PEPs
                      </a>
                    </li>
                    <li class="ripple">
                      <a href="/ukk-view#/ukk-dttot">
                         <span class="fa fa-user-times"></span>Dokumen DTTOT
                      </a>
                    </li>
