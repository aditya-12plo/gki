...
<div class="breadcrumb"> 
  <div class="panel">
    <h1 class="animated fadeInLeft" align="center">Form Penambahan Karyawan</h1>                
  </div>
</div>
...
export default {
  ...
  data () {
    return {
        ...
        jabatanDropdown: [],
        divisiDropdown: [],
        forms: {nama:'', nomor_aplikasi:'', jabatan:'', divisi:'', awal_masuk:'', cuti:'', dokumen:''},
            ...
            submitData() {
                ...
                confirmButtonText: 'Yes!'
                    ...
                    if (result.value) {
                        ...
                        axios.post('/hrd-karyawan', masuk).then(response => {
                            if(!response.data){ 
                                window.location.href = window.webURL; 
                            }else{ 
                                if(response.data.status == 200){ 
                                    this.errors = '';
                                    this.forms.nama = '';
                                    this.forms.nomor_aplikasi = '';
                                    this.forms.awal_masuk = '';
                                    this.forms.cuti = '';
                                    this.forms.dokumen = ''; 
