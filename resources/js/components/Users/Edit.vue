...
<div class="breadcrumb"> 
  <div class="panel">
    <h1 class="animated fadeInLeft" align="center">Edit User</h1>                
  </div>
</div>
    ...
    <div class="card-body">
        <div class="d-flex flex-column">
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" v-model="forms.password">
            </div> 
            <div class="form-group">
                <label>Status</label>
...
export default {
  ...
  data () {
    return {
        ...
        forms: new CrudForm({id:'', name:'', email:'', status:'',role_id:'', role:[], password : ''}),
        ...
        methods: { 
            ...
            submitData() {
                ...
                confirmButtonText: 'Yes!'
                    ...
                    if (result.value) {
                        axios.put('/users/'+this.forms.id, this.forms).then(response => {
                            if(!response.data){ 
                                window.location.href = window.webURL; 
                            }else{ 
                                if(response.data.status == 200){  
