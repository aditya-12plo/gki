...
<div class="breadcrumb"> 
  <div class="panel">
    <h1 class="animated fadeInLeft" align="center">Profil Perorangan</h1>                
  </div>
</div>
                                ...
                                <div class="dataTables_length" id="zero_configuration_table_length">
                                    <div class="row row-xs"> 
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" v-model="filterText" class="form-control form-control-sm" @keyup.enter="doFilter" placeholder="Email / Nama / Nomor Akun"> 
                                        </div>
                                        <div class="col-md-12">
                                            <br> 
    ...
    return {  
        ...
        methods: {
            ...
            editItem(item ,index = this.indexOf(item)){
                this.$router.push({name:'OpsPeroranganEdit', params: {id: this.diacak(item.id),typenya:'edit-perorangan',rowDatanya:item }});
            },  
            viewItem(item ,index = this.indexOf(item)){
                this.$router.push({name:'OpsPeroranganDetail', params: {id: this.diacak(item.id),typenya:'detail-perorangan',rowDatanya:item }});
            } ,
            ...
            onLoadingError() {
               this.isLoading = true;
               axios.get('perorangan').then((response) => {
                   if(!response.data){ 
